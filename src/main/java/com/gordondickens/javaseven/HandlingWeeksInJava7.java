...
import com.gordondickens.javaseven.concurrency.UsingJoinForkFrameworkInJava;
...
public class HandlingWeeksInJava7 {
    private static final Logger logger = LoggerFactory.getLogger(UsingJoinForkFrameworkInJava.class);
